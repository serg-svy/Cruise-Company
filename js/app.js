(() => {
    ...
    da.init();
    let paths = document.querySelectorAll(".path-line");
    paths.forEach((path => {
    ...
    const videoFile = document.querySelector(".video__object");
    const videoImage = document.querySelector(".video__cover");
    videoBtn.addEventListener("click", (function(e) {
        function toggleOverlay(event) {
            if ("mouseleave" === event.type) videoOverlay.classList.add("hidden"); else videoOverlay.classList.remove("hidden");
        }
        if (videoFile.paused) {
            videoFile.play();
            videoIcon.src = "img/icons/pause.svg";
            videoImage.classList.add("hide");
            videoOverlay.onmouseleave = toggleOverlay;
            videoOverlay.onmouseenter = toggleOverlay;
        } else {
            videoFile.pause();
            videoImage.classList.remove("hide");
            videoIcon.src = "img/icons/play.svg";
